...
public class SpectriumTorch extends BaseBlock{
    ...
    public static TextureAtlasSprite textureAtlas;
    
    public SpectriumTorch(Material material, String name)
    {
        super(material, name);
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        ...
        if (enumfacing.getAxis().isHorizontal())
        {
        	...
        	SpectrumCraft.proxy.generateRainbowFlames(worldIn, d0 + 0.27D * (double)enumfacing1.getFrontOffsetX(), d1 + 0.22D, d2 + 0.27D * (double)enumfacing1.getFrontOffsetZ(), 0.0D, 0.0D, 0.0D);
        ...
        {
        	SpectrumCraft.proxy.generateRainbowFlames(worldIn, d0, d1, d2, 0.0D, 0.0D, 0.0D);
